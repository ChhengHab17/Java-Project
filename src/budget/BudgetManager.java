    ...
    public String getBudgetDetails() {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                String formatWeekly = String.format("%.2f", weekly);
                String formatMonthly = String.format("%.2f", monthly);
                String formatConvertedWeekly = String.format("%.2f", convertedWeekly);
                String formatConvertedMonthly = String.format("%.2f", convertedMonthly);
                String opCurrency = "KHR";
                if(currency.equalsIgnoreCase("KHR")) {
                    opCurrency = "USD";
                }
                return "User ID: " + userID + "\n" +
                       "Weekly Budget in " + currency+ " :" + formatWeekly + currency + "\n" +
                       "Monthly Budget in "  + currency+ " :" +  formatMonthly + currency + " \n" +
                       "Weekly Budget in "  + opCurrency+ " :" + formatConvertedWeekly + opCurrency + " \n" +
                       "Monthly Budget in "  + opCurrency+ " :" + formatConvertedMonthly + opCurrency + " \n" +
